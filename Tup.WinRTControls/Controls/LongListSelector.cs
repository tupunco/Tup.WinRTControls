...
namespace Tup.WinRTControls.Controls
{
    ...
    /// <remarks>
    /// FROM: Microsoft.Phone.Controls.Toolkit.LongListSelector
    /// </remarks>
    ...
    public class LongListSelector : Control
    {
        ...
        /// </summary>
        private object InternalSelectedItem { get; set; }
        /// <summary>
        /// Gets or sets the selected item.
        /// </summary>
        public object SelectedItem
        {
            ...
            set
            {
                if (_listBox != null)
                {
                    ...
                    {
                        foreach (LongListSelectorItem tuple in (IEnumerable)_listBox.ItemsSource)
                        {
                            if (tuple.Item == value)
                            {
        ...
        /// <summary>
        /// The ItemContainerStyle provides the style for the items in the items view.
        /// </summary>
        ...
        public static readonly DependencyProperty ItemContainerStyleProperty =
            DependencyProperty.Register("ItemContainerStyle", typeof(Style), typeof(LongListSelector), new PropertyMetadata(null, OnItemContainerStyleChanged));
        #endregion
        ...
        private void UpdateItemContainerStyle(Style newStyle)
        {
            if (_listBox == null)
                return;
        ...
        /// <param name="o"></param>
        /// <param name="e"></param>
        private static void OnItemContainerStyleChanged(DependencyObject o, DependencyPropertyChangedEventArgs e)
        {
            LongListSelector lls = (LongListSelector)o;
            if (lls._listBox == null)
                return;

            lls.UpdateItemContainerStyle((Style)e.NewValue);
        }
        /// <summary>
        ...
        private void OnSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            else
            {
                ...
                if (handler != null)
                {
                    ...
                    handler(this, new SelectionChangedEventArgs(removedItems.Cast<object>().ToList(), addedItems.Cast<object>().ToList()));
                }
            }
    ...
    public class TemplatedListBox : ListBox
    {
        ...
        protected override void PrepareContainerForItemOverride(DependencyObject element, object item)
        {
            ...
            if (itemTuple != null)
            {
                ...
                if (itemTuple.ItemType == LongListSelectorItemType.Item)
                    listBoxItem.Style = ItemContainerStyle;
                else
                    listBoxItem.Style = (Style)Application.Current.Resources["BaseTemplatedListBoxItemStyle"];
    ...
    /// </summary>
    /// <QualityBand>Preview</QualityBand>
    public class TemplatedListBoxItem : ListBoxItem
    {
        public TemplatedListBoxItem()
        {
            DefaultStyleKey = typeof(TemplatedListBoxItem);
        }
    ...
    /// </summary>
    internal static class TemplatedVisualTreeExtensions
    {
